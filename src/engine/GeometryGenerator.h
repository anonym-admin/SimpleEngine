...
public:
	...
	static MeshData_t* ReadFromFile(Application* pApp, AkU32* pMeshDataNum, const wchar_t* wcBasePath, const wchar_t* wcFilename, AkBool bIsAnim = false, Matrix* pDefaultMat = nullptr, Matrix const** pBoneOffsetMat = nullptr, AkI32 const** pBoneHierarchy = nullptr, AkU32* pBoneNum = nullptr);
