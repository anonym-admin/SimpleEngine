...
public:
	...
	virtual ILandScape* CreateLandScapeObject() override;
	...
	virtual void* CreateDynamicVertices(AkU32 uSizePerVertex, AkU32 uVertexNum) override;
	...
	virtual void RenderLandScapeObject(ILandScape* pLandScapeObj, const Matrix* pWorldMat) override;
